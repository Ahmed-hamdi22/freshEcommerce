      ...
      <div className="grid bg- grid-cols-5 shadow my-10 p-5">
        ...
        <div className=" col-span-4 flex items-center px-4">
          <div className="w-full">
            <h2 className=" md:text-4xl mb-3 text-2xl text-black font-bold">
              {productDetails?.slug}
            </h2>
            ...
            <div className="flex justify-between items-center">
              ...
              <i className="fas fa-star text-yellow-400 text-xs ">
                <span className="text-slate-800 ms-1 ">
            ...
            <div className="flex mt-8 justify-between items-center">
              <button
                ...
                disabled={isAdding}
                className="mt-3 lg:px-20 text-center bg-main text-white p-2 hover:bg-[#0fc80f] focus: focus:outline-[#0fc80f] focus:bg-[#0fc80f] font-medium rounded"
              >
                {!isAdding ? (
                  "+ Add"
                ) : (
