    ...
    <div className="shadow border hover:border-lime-400">
      <div className="p-3">
        <Link to={"/productDetails/" + product._id}>
          ...
          <h5 className="font-light text-[#0fc80f] ">
        ...
        <div className="flex items-center justify-center">
          <button
            ...
            className="mt-3 w-full text-center bg-main text-white p-2 hover:bg-[#0fc80f] focus: focus:outline-[#0fc80f] focus:bg-[#0fc80f] font-medium rounded-lg"
          >
            {!isLoading ? (
              "add to cart"
            ) : (
          ...
          <i
            onClick={() => {
              addOrRemoveWish(), setAddedToWish(!isAddedToWish);
            }}
            className={`${
              isAddedToWish ? "text-red-500" : "text-gray-600"
            } fas fa-heart   mt-4 ms-4 fa-xl `}
          ></i>
        </div>
      </div>
    </div>
